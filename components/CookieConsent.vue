<template>
    <div v-if="show" class="cookie-consent-container">
      <div class="content-container">
        <p class="font-light text-gray-300">We use cookies to improve your browsing experience on our site. By using our site, you consent to our use of cookies. 
          <a href="/privacy-policy" class="font-light underline text-blue-400">Learn more</a>
        </p>
  ...
  export default {
    ...
    computed: {
      cookiesAccepted() {
        return document.cookie.split(';').some((item) => item.trim().startsWith('cookies-accepted='));
      },
    },
    methods: {
      acceptCookies() {
